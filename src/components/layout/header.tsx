      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex h-20 items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <Image src="/images/LOGO LEXFOR-SIN FONDO.png" alt="LEXFOR Logo" width={130} height={40} className="object-contain" />
                ...
                <SheetHeader className="p-4 border-b">
                    <SheetTitle asChild>
                       <div className="flex justify-between items-center">
                        <Link href="/">
                            <Image src="/images/LOGO LEXFOR-SIN FONDO.png" alt="LEXFOR Logo" width={120} height={35} className="object-contain" />
                        </Link>
                      </div>
                    </SheetTitle>
                </SheetHeader>
